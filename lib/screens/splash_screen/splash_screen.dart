import 'package:final_project2/kakao_login_screen/kakao_login_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 5), (){
      ...
      Navigator.pushNamedAndRemoveUntil(context, KakaologinScreen.routeName, (route) => false);
    });
  }
  @override
